  ...
  const textureCreators = [
    {
      ...
      description: 'Criador da maioria das texturas e mods incríveis para o PSP.',
    },
    {
      name: 'sexy shrek',
      role: 'Texture Artist',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=sexyshrek&backgroundColor=c0aede',
      description: 'Especialista em texturas e UI, co-criador de vários pacotes.',
    },
    {
      name: 'Bonkunph',
      role: 'Modder & Artist',
      avatar: 'https://i.postimg.cc/8FKzYSMr/image.png',
      description: 'Contribuidor de mods e texturas clássicas.',
    }
  ];
  ...
  const siteCreators = [
    {
      ...
      avatar: 'https://i.postimg.cc/Z911nshF/image.png',
      description: 'Desenvolvedor principal e idealizador do PSPrinth.',
    }
  ];
    ...
    >
      ...
      <div className="bg-[#5865F2]/10 border border-[#5865F2]/30 rounded-2xl p-8 md:p-12 mb-16 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-text mb-6">
            Junte-se à nossa <span className="text-[#5865F2]">Comunidade</span>
          </h1>
          <p className="text-xl text-secondary mb-8">
            Faça parte do nosso servidor no Discord! Converse com outros jogadores, compartilhe suas criações, tire dúvidas e fique por dentro de todas as novidades do Minecraft PSP.
          </p>
          <a 
            href="https://discord.gg/WFhyQdAVps" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-[#5865F2] hover:bg-[#4752C4] text-white px-8 py-4 rounded-xl font-bold text-lg transition-all hover:scale-105 active:scale-95 shadow-lg shadow-[#5865F2]/25"
          >
      ...
      <div className="mb-16">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl font-bold text-text">Principais Criadores</h2>
        </div>
      ...
      <div>
        <div className="flex items-center gap-3 mb-8">
          ...
          <h2 className="text-3xl font-bold text-text">Criadores do Site</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
